...
const HomePage: React.FC<HomePageProps> = () => {
	...
	const isLoading = useSelector((state: RootState) => isStatusLoading(state.events.status.createEvent));
	...
	return (
		<>
			...
			<div className='app-container d-flex-center-center'>
				<CreateEventForm form={form} onFinish={handleFormFinish} isLoading={isLoading} />
			</div>
		</>
	);
};
