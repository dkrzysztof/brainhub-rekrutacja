...
import { render, cleanup, act, fireEvent, screen, getByText, getByPlaceholderText } from '@testing-library/react';
...
const changeDateValue = async (datePickerElement: HTMLElement, datestring: string) => {
...
describe('CreateEventForm', () => {
	...
	it('passes correct object on onFinish', async () => {
		const { form, inputDate, inputEmail, inputFirstname, inputLastname, buttonSubmit, baseElement } = setup({
			onFinish: handleFinish
		});
